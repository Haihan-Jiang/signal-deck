...
class JobApplyAgentTests(unittest.TestCase):
    ...
    def test_automation_handoff_report_prioritizes_answers_and_stop_actions(self) -> None:
        ...
        self.assertIn("final-answer-reply", report["one_command_resume"])
        self.assertIn("job_apply_agent/outbox/final_answer_reply_template_latest.txt", report["one_command_resume"])
        ...
        self.assertIn("final-answer-reply", report["next_commands"][0])
        self.assertIn("job_apply_agent/outbox/final_answer_reply_template_latest.txt", report["next_commands"][0])
        ...
        self.assertIn("job_apply_agent/outbox/final_answer_reply_template_latest.txt", report["next_commands"][3])
        ...
        self.assertIn("final-answer-reply", markdown)
        self.assertIn("job_apply_agent/outbox/final_answer_reply_template_latest.txt", markdown)
